...
switch ($op) {
    case 'grava':
        ...
        if ('' == $form['grafico']) {
            ...
            $maxfilesize = 500000;
            $uploader    = new \XoopsMediaUploader($local_folder, require XOOPS_ROOT_PATH . '/modules/' . $xoopsModule->dirname() . '/include/mimetypes.php', $maxfilesize);
    ...
    default:
        ...
        $adminObject->displayNavigation('inser.php');
        //echo '<br><br><br><br><br><br>';
