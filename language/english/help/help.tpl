<div id="help-template" class="outer">
    <{include file=$smarty.const._MI_RWBANNER_HELP_HEADER}>

    <h4 class="odd">DESCRIPTION</h4>

    <p class="even">rwBanner is a module for managing and showing random banners, that can be used or not together with the default xoops banner system.<br> <br>
    ...
    <a href="https://www.gitbook.com/book/xoops/xoops-operations-guide/" target="_blank">XOOPS Operations Manual</a><br> <br></p>

    <h4 class="odd">TUTORIAL</h4>

    <p class="even">
        Tutorial has been started, but we might need your help! Please check out the status of the tutorial <a href="https://www.gitbook.com/book/xoops/rwbanner-tutorial/" target="_blank">here </a>.
        <br><br>To contribute to this Tutorial, <a href="https://github.com/XoopsDocs/rwbanner-tutorial/" target="_blank">please fork it on GitHub</a>.
    ...
    <p class="even">This module is Open Source and we would love your help in making it better! You can fork this module on <a href="https://github.com/XoopsModulesArchive/rwbanner" target="_blank">GitHub</a><br><br>
